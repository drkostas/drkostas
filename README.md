...
* 🏆 Latest paper: [ExPLoRe](https://github.com/aicip/ExPLoRe) — ECCV 2026. Per-patch loss-coupling via Soft-MoE dispatch weights for multi-objective masked image modeling. ViT-Base → 80.6% linear probe / 85.3% finetune on ImageNet-1K.
